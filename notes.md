...
### Project: Change Background Color [0327.html]
  ...
  - Used ```transform: translate[-50%, -50%]``` to reposition the elements in the center horizontally and vertically taking into account the widthand height of the element.``
